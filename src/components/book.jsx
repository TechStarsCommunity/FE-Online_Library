    ...
    return (
        <div className="p-[2rem]">
                ...
                <div className="flex flex-col gap-[3.5rem] p-[.3rem]">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <p className="text-[1rem] font-serif text-[#858585]">
                            <span className="text-[#001E50] font-semibold">Level:</span> Beginner
                        </p>
                    </div>
                </div>
            </div>
            <p className="text-[#858585] text-[1.25rem] font-serif font-normal mt-[2.5rem] leading-tight">
                ...
                technology, “ Starting a Successful career in Tech” is your compass for embarking on
                a miraculous journey. Unlock the doors to endless opportunities, unleash your
                potential, discover the fundamental principles and core technology driving the
                digital age and lay the foundation for a successful and fulfilling career in the
                world of technology.
            </p>
