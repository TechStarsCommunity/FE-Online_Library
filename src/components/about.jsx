                ...
                <div className="md:px-[50px] lg:max-w-screen-lg lg:mx-auto">
                    ...
                    <div className="text-[#727272] md:text-[16px] text-justify text-[12px] lg:text-[18px]">
                        <p className="my-[10px] md:my-[20px] lg:my-[30px]">
                            Welcome to BooksLab, your online resource library for books and
                            articles. Created by the Techstars community, we connect individuals
                            worldwide with a vast collection of verified books curated by experts.
                            Our unique roadmap feature guides you from beginner to advanced in your
                            chosen tech field, with regular updates to keep you up-to-date on the
                        ...
                        <p className="my-[10px] md:my-[20px] lg:my-[30px]">
                            ...
                            us help you achieve your learning goals. Join us on a knowledge-driven
