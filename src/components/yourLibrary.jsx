    ...
    return (
        <>
                ...
                ReaderProfile.map((readerProfile) => {
                    return (
                        <div className='profile'>
                            <div className='flex item-center justify-between py-10' key={readerProfile.id}>
                                <img src={readerProfile.notification} alt="alt" />
                                <br />
                                <div className='profilename'>
                                    <div><strong>{readerProfile.name}</strong></div>
                                    <br />
            ...
            <div className='recentlyRead'>
                <h1 className='py-3'><strong>Recently Read</strong></h1>
                {BookRead &&
                    BookRead.map((bookRead) => {
                        return (
                            <div>
                                <div className='flex item-center justify-between bookRead' key={bookRead.id}>
            ...
            <div className='topAuthors'>
                <h1 className='py-3'><strong>Top Authors</strong></h1>
                {Authors &&
                    Authors.map((authors) => {
                        return (
                            <div className='auth'>
                                <div className='flex item-center justify-between' key={authors.id}>
                                    ...
                                    <br />
                                    <div className='name'><strong>{authors.name}</strong></div>
                                </div>
                            </div>
                        );
                    })}
