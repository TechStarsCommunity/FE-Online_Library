...
const LeftSidebar = ({ active, setActive }) => {
    ...
    return (
        <React.Fragment>
            <div className="">
                <h1 className="mt-[50px] mb-[50px]"><img src={booksLabLogo} alt="Logo" /></h1>
                ...
                <div className="">
                    {Tabs.map((data) => {
                        ...
                        return(
                            <div 
                              ...
                              px-8 button cursor-pointer ${active === data.id ? "button-active-style" : ""}`} 
                              >
                    ...
                    <div 
                        ...
                        >
                        <span className="me-4"> <AiOutlineLogout /></span>
