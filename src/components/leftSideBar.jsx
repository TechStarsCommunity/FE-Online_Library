    ...
    return (
        <React.Fragment>
            <div className="relative bg-black h-full">
                <h1 className="mt-[50px] mb-[50px] mx-auto w-[60%]"><img src={booksLabLogo} alt="Logo" /></h1>
                ...
                <div className="mt-[100px]">
                    {Tabs.map((data) => {
                        ...
                        return(
                            <div 
                              ...
                              px-8 button cursor-pointer ${active === id ? "button-active-style" : ""}`} 
                              >
                    ...
                    <div 
                        ...
                        >
                        <span className="me-4 text-[24px]"> <AiOutlineLogout /></span>
